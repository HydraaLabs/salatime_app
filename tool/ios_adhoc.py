...
SOURCE_RUN = 35165814554
SOURCE_SHA = "f809e1ccbecab998fcdd2f27dec82e844c09fd50"
BUILD = "27"
VERSION = "1.0.22"
...
def resign() -> None:
    ...
    result = directory / "SalaTime-AdHoc-27.ipa"
    ...
    secret_file(output / "SalaTime-AdHoc-27.ipa.enc", sealed)
...
def decrypt() -> None:
    ...
    payload = unseal((directory / "SalaTime-AdHoc-27.ipa.enc").read_bytes(), password, report_bytes)
