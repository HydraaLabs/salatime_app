...
def resign() -> None:
    ...
    result = directory / "SalaTime-AdHoc-28.ipa"
    ...
    secret_file(output / "SalaTime-AdHoc-28.ipa.enc", sealed)
...
def decrypt() -> None:
    ...
    payload = unseal((directory / "SalaTime-AdHoc-28.ipa.enc").read_bytes(), password, report_bytes)
