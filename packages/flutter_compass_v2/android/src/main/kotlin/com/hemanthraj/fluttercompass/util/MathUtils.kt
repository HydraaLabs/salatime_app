...
import com.hemanthraj.fluttercompass.model.Azimuth
...
object MathUtils {
    ...
    fun calculateAzimuth(rotationVector: RotationVector, displayRotation: DisplayRotation): Azimuth? {
        ...
        return finiteAzimuthOrNull(azimuthInDegrees)
    }

    internal fun finiteAzimuthOrNull(degrees: Float): Azimuth? =
        if (degrees.isFinite()) Azimuth(degrees) else null
